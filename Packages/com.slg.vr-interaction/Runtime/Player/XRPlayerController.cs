...
namespace UnityEngine.VRInteraction
{
    public class XRPlayerController : MonoBehaviour
    {
        ...
        private void UpdateHead()
        {
            ...
            _headBodyJoint.connectedAnchor = _pelvisCapsule.transform.InverseTransformDirection(Vector3.up * (_bodyHeight - _realCrouchAmount));
        }

        private void UpdateCrouch()
        {
            _crouchOffset = Mathf.MoveTowards(_crouchOffset, _crouchTargetOffset, 2f * Time.fixedDeltaTime);
        ...
        {
            Vector3 delta = Vector3.Scale(_rig.Camera.transform.position - _head.transform.position, new Vector3(1, 0, 1));
